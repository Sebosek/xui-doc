...
import { error } from '@xui/components/dist/collection/utils/toasts';
...
import Avatar from '../../wrappers/AvatarWrapper';
...
const AvatarDetail: FunctionComponent = () => {
  ...
  const handleAvatarError = () => error('Unable to load avatar.');
